...
if __name__ == "__main__":
    dfea = pd.read_csv('outputs_paper_aiaa_coevolution/rslt_ea.csv')
    dfrand = pd.read_csv('outputs_paper_aiaa_coevolution/rslt_random.csv')
    # dfccea = pd.read_csv("ccea_pop.csv")
    dfccea = pd.read_csv("outputs_paper_aiaa_coevolution/rslt_ccea.csv")
