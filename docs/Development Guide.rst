...
* It's also important to ensure the documentation (both source files and html) stay up to date with the release. Currently, this is managed by the person conducting the release by committing the new html to the ``gh-pages`` branch.
