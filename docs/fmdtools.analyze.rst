...
.. image:: figures/uml/analyze_module_structure.png
   :width: 800
...
- :mod:`fmdtools.analyze.history`, which defines the :class:`fmdtools.analyze.history.History` classe for tracking, saving, and processing simulation logs/histories. 
