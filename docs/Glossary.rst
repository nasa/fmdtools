...
.. glossary::
	...
	Approach
		A set of :term:`scenario` s to simulate a model over to represent certain hazards or parameters of interest. May be generated using :class:`fmdtools.sim.sample.SampleApproach` for fault modes or :class:`fmdtools.sim.approach.NominalApproach` for nominal parameters. 
	
	Nested Approach
		The result of simulating a fault sampling :term:`Approach` (:class:`fmdtools.sim.sample.SampleApproach`) within a nominal :term:`Approach` (:class:`fmdtools.sim.approach.NominalApproach`). Created in :func:`fmdtools.sim.propagate.nested_approach`
