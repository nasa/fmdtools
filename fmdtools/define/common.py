...
Functions contained in this module:
    ...
    -:func:`get_true_fields`:Resolves the args to pass to a dataobject given certain defaults
    -:func:`get_true_field`:Gets the value that will be set to fieldname given *args and **kwargs
    -:func:`is_iter`: Checks whether a data type should be interpreted as an iterable or not.
    -:func:`check_pickleability`:Checks to see which attributes of an object will pickle (and thus parallelize)"
    -:func:`init_obj_attr`:Initializes attributes to a given object
    -:func:`get_dataobj_track`:Gets tracking params for a given dataobject (State, Mode, Rand, etc)
