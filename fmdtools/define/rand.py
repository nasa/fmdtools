# -*- coding: utf-8 -*-
"""
Description: A module for defining randon properties for use in blocks. Has Classes and Functions:
    
- :class:`Rand`:               Superclass for Block random properties.

- :func:`get_pdf_for_rand`:     Gets the corresponding probability mass/density for random sample x 
                                from 'randname' function in numpy.
- :func:`get_scipy_pdf_helper`: Gets probability mass/density for the outcome x from the distribution "randname".
