...
fmdtools requires Python 3 and depends directly on these packages:
...
Examples, Documentation, and Reading
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
`Daniel Hulse <https://github.com/hulsed>`_
