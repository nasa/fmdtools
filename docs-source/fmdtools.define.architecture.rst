...
.. figure:: ../examples/human_hazard_mitigation/main_model_aa.svg
   :width: 800
...
.. figure:: ../examples/human_hazard_mitigation/main_model_aa_frdl.svg
   :width: 600
   :alt: Structure of an ActionArchitecture in FRDL
   
   Propagation network of example Action Architecture.

For more info on this example, see: :doc:`The Action Sequence Graph Demo Model <../examples/human_hazard_mitigation/readme>`.
